...
public class AppliedSciences extends Department {
	...
	public String toString() {
		...
		return "If you pass the Trace and finish " + getName()
				...
				+ (getCalcTotalPrice() + getPREPPRICE()) + " TL and you will have paid a total of " + this.getPriceUniform() + "TL for the uniform."
				+ "\n\n" +
				...
				+ " TL. \n" + "If you finish " + getName() + " department in 5 years, you will have paid a total of "
				+ ((getCalcTotalPrice() + getPREPPRICE()) * (3 / 4)) + " TL and you will have paid a total of " + this.getPriceUniform()
				+ "TL for the uniform." + "\n\n" +
				...
				+ " TL. \n" + "If you finish " + getName() + " department in 5 years, you will have paid a total of "
				+ ((getCalcTotalPrice() + getPREPPRICE()) * (1 / 2)) + " TL and " + this.getPriceUniform()
