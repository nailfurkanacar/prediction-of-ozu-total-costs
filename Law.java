...
public class Law extends Faculties {
	...
	public String toString() {
		...
		return "Department Name:" + getName() + "\n"
				...
				+ getName() + " department in 4 years, you will have paid a total of " + getCalcTotalPrice()
				+ " TL. \n\n" +

				"If you get 25% scholarship and  If you finish " + getName()
				+ " department in 4 years, you will have paid a total of " + (getCalcTotalPrice() * (3.0 / 4.0))
				+ " TL. \n\n" +

				"If you get 50% scholarship and  If you finish " + getName()
